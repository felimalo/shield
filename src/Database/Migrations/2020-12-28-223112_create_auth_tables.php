...
class CreateAuthTables extends Migration
{
    ...
    public function up(): void
    {
        ...
        $this->forge->createTable($this->tables['identities'], true);
        ...
        $this->forge->createTable($this->tables['logins'], true);
        ...
        $this->forge->addKey('user_id');
        // NOTE: Do NOT delete the user_id or identifier when the user is deleted for security audits
        $this->forge->createTable($this->tables['token_logins'], true);
        ...
        $this->forge->addForeignKey('user_id', $this->tables['users'], 'id', '', 'CASCADE');
        $this->forge->createTable($this->tables['remember_tokens'], true);
        ...
        $this->forge->addPrimaryKey('id');
        $this->forge->addForeignKey('user_id', $this->tables['users'], 'id', '', 'CASCADE');
        $this->forge->createTable($this->tables['permissions_users'], true);
    }
